...
class VlrApiEventIngestionSource:
    ...
    def __init__(
        self,
        provider: VlrApiIngestionProvider,
        *,
        ...
        self._match_normalizer = match_normalizer or VlrApiMatchNormalizer()
        self._player_id_map: dict[str, int] = {}
    ...
    def load_event_page(self, event_id: int) -> NormalizedEventPageData:
        ...
        self._player_id_map = self._event_normalizer.build_player_id_map(event_data)
    ...
    def load_match(self, match_id: int, event_id: int) -> NormalizedMatchData:
        ...
        return self._match_normalizer.normalize(
            ...
            event_id=event_id,
            event=self._event,
            player_id_map=self._player_id_map,
        )
